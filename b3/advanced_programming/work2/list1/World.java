...
class World implements Cloneable {
    ...
    @Override
    public int hashCode() {
        return this.missionary*100+this.cannibal*10+this.boat;
    }
    ...
    // actionをworldに適応して、適応後のworldを返す関数
...
class Action {
    ...
    Action(int missonary, int cannibal, int boat) {
        this.missionary = missonary;
